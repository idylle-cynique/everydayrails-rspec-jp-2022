...
RSpec.describe Note, type: :model do
  ...
  # 検索文字列に一致するメモ(ノート)を検索する
  describe "search message for a term" do
    before do
      @note1 =
        @project.notes.create(message: "Thist is the first note.", user: @user)
      ...
      puts Note.search("first").inspect
      puts @note1.inspect

      # "first"を含むメモレコード群に引数に与えたモデルが含まれているかどうかをチェックする
